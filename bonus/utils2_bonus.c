...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/12 12:47:57 by jgoo              #+#    #+#             */
/*   Updated: 2024/02/12 12:47:59 by jgoo             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	alloc_lookat_matrix(t_map *map)
{
	...
	if (map->la_matrix == NULL)
		exit_error(MERR);
	map->la_matrix->eye_position = set_vector(0, 0, -1, 1);
	map->la_matrix->eye_direction = set_vector(0, 0, 1, 0);
